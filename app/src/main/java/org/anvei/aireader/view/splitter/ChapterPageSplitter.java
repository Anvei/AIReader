...
public class ChapterPageSplitter {
    ...
    private int maxCharWidthPerLine;
    ...
    public int getMaxCharWidthPerLine() {
        return maxCharWidthPerLine;
    }

    public void setMaxCharWidthPerLine(int maxCharWidthPerLine) {
    ...
    public ChapterPageSplitter(int maxLines, int maxCharWidthPerLine) {
        this.maxLines = maxLines;
        this.maxCharWidthPerLine = maxCharWidthPerLine * ENG_CHAR_WIDTH;
    }

    public static final int ENG_CHAR_WIDTH = 3;
    public static final int SPECIAL_CHAR_WIDTH = 5;
